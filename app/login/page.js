...
export default function Login() {
    ...
    return (
        <div>
            <div>
                {/* <!-- component --> */}
                <section id="contact" className="relative w-full min-h-screen bg-black text-primary">
                    ...
                    <div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
                        ...
                        <form onSubmit={handleSubmit} className="w-full md:w-1/2 border border-secondary p-6 bg-gray-900">
                            ...
                            <div className="w-full pt-3">
                                <button type="submit" className="w-full bg-gray-900 border border-secondary px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-secondary hover:text-black text-xl cursor-pointer">
                                    Login
                                </button>
                            </div>
                        </form>
